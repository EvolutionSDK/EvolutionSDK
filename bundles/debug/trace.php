...
<div id="-e-debug-panel-wrap" class="<?php echo class_exists('Bundles\Portal\Bundle', false) ? (Bundles\Portal\Bundle::$currentException instanceof Exception ? 'open' : 'closed') : 'closed'; ?>">
	<div id="-e-debug-panel" class="windowed show-important">
		...
		<div class="body">
			...
			<?php if(class_exists('Bundles\Portal\Bundle', false) && Bundles\Portal\Bundle::$currentException instanceof Exception) {
